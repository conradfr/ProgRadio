...
const fetchSections = async (id) => {
  const response = await node_fetch(`https://www.radiofrance.fr/api/v1.7/stations/franceculture/programs/${id}/chronicles`);
...
const fetch = dateStr => {
  let url = `https://www.radiofrance.fr/api/v1.7/stations/franceculture/programs?date=${dateStr}`;
