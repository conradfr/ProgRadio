...
set :linked_dirs, fetch(:linked_dirs, []).push("vendor", "node_modules", "Scraper/node_modules", "public/media/program", "public/media/stream", "public/media/temp", "public/media/cache/program_thumb/media/program", "public/media/cache/page_thumb/media/program", "public/media/cache/notification_thumb/media/program", "Importer/deps")
