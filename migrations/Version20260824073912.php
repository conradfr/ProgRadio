 ...
 */
final class Version20260824073912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadioId = 352;
        $streamSongId = 148;
        $website = 'https://www.montagnefm.com';
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://montagnealb.ice.infomaniak.ch/montagnealb-128.mp3',
                'id' => '961748d5-0601-11e8-ae97-52543be04c81'
            ],
        ];
