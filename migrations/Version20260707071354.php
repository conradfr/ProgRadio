 ...
 */
final class Version20260707071354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadios = [
            [
                ...
                'main' => 'true',
                'radio_id' => $radioId,
                'url' => 'https://sc.creacast.com/vfm',
                'id' => '96145a4e-0601-11e8-ae97-52543be04c81'
            ],
        ];
