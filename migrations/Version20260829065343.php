 ...
 */
final class Version20260829065343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadioId = 433;
        $streamSongId = 91;
        $website = 'https://www.chantefrance.com/';
        ...
        $subRadios = [
            [
                ...
                'id' => '490796d4-3b76-4dd5-8a5e-5223b60b1433'
            ],
            [
                'code_name' => 'paris',
                'name' => 'Chante France Paris',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://chantefrance75.ice.infomaniak.ch/chantefrance75-96.aac',
            ],


            [
                'code_name' => 'party',
                'name' => 'Chante France Party',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => false,
                'url' => 'https://chantefranceparty.ice.infomaniak.ch/chantefranceparty-96.aac',
            ],
            [
                'code_name' => '902000s',
                'name' => 'Chante France 90-2000s',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => false,
                'url' => 'https://chantefrance90-2000.ice.infomaniak.ch/chantefrance90-2000-96.aac',
            ],
        ];
