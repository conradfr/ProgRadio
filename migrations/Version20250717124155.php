 ...
 */
final class Version20250717124155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        for ($i = 0; $i < count($radios); $i++) {
            $this->connection->exec(
                ...
                . ($i + 152) . ',' . $radios[$i]['category'] . ",'" . $radios[$i]['code_name'] . "','" . $radios[$i]['name'] . "','" . $radios[$i]['country'] . "','" . $radios[$i]['timezone'] . "'," . $radios[$i]['share'] . "," . $radios[$i]['collection'] . ");"
            );
        }
        ...
        for ($i = 0; $i < count($subRadios); $i++) {
            $this->connection->exec(
                ...
                . ($i + 293) . ',' . $subRadios[$i]['radio_id'] . ",'" . $subRadios[$i]['code_name'] . "','" . $subRadios[$i]['name'] . "'," . $subRadios[$i]['main'] . ',true);'
            );
        }
