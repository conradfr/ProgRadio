 ...
 */
final class Version20260821150829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $prefix = 'radio_goodlife';
        $radioId = 170;
        $subRadioId = 344;
        $streamSongId = 145;
        $website = 'https://radiogoodlife.com';
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://gestream.fr/g-radio-hd.mp3',
                'id' => '9607cade-0601-11e8-ae97-52543be04c81'
            ],
        ];
