 ...
 */
final class Version20260829092800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadios = [
            [
                'code_name' => 'epinal',
                'name' => 'Vosges FM Epinal',
                'main' => 'true',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://str0.creacast.com/vosgesfm-epinal',
            ],
            [
                'code_name' => 'bruyeres',
                'name' => 'Vosges FM Gérardmer - Bruyères',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://str0.creacast.com/vosgesfm-bruyeres',
                'id' => '961abf52-0601-11e8-ae97-52543be04c81'
            ],
            [
                'code_name' => 'cornimont',
                'name' => 'Vosges FM La Bresse - Cornimont',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://ice.creacast.com/vosgesfm-cornimont',
            ],
            [
                'code_name' => 'remiremont',
                'name' => 'Vosges FM Remiremont',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://str0.creacast.com/vosgesfm-remiremont',
                'id' => '961ac00f-0601-11e8-ae97-52543be04c81'
            ],
        ];
