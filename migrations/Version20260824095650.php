 ...
 */
final class Version20260824095650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadioId = 354;
        $streamSongId = 150;
        $website = 'https://www.activradio.com';
        ...
        $subRadios = [
            [
                'code_name' => 'firminy',
                'name' => 'Activ Radio Firminy',
                'main' => 'true',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://activradio-stetienne.ice.infomaniak.ch/stetienne.mp3',
                'id' => '68c093eb-f598-47d7-bef6-e88bdaffae29'
            ],
            [
                'code_name' => 'saintetienne',
                'name' => 'Activ Radio Saint-Étienne',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://activradio-stetienne.ice.infomaniak.ch/stetienne.mp3',
                'id' => '3026c7a0-ecf9-4108-b149-ba2b0423bdf9'
            ],
            [
                'code_name' => 'roanne',
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://activradio-roanne.ice.infomaniak.ch/roanne.mp3',
                'id' => '9607c96b-0601-11e8-ae97-52543be04c81'
            ],
            [
                'code_name' => 'supporters',
                'name' => 'Activ La Radio Des Supporters',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => false,
                'url' => 'https://laradiodesverts.ice.infomaniak.ch/laradiodesverts.mp3',
            ],
            [
                'code_name' => 'before',
                'name' => 'Activ Le Before Mix Electro ',
                'main' => 'false',
                'radio_id' => $radioId,
                'sub_radio' => false,
                'url' => 'https://beforeactiv.ice.infomaniak.ch/beforeactiv.mp3'
            ],
        ];
