 ...
 */
final class Version20260706222219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadioId = 322;
        $streamSongId = 129;
        $website = 'https://www.radionimes.fr';
        ...
        $subRadios = [
            [
                ...
                'main' => 'true',
                'radio_id' => $radioId,
                'url' => 'https://stream.votreradiosurlenet.eu/radionimes.mp3',
                'id' => '96168769-0601-11e8-ae97-52543be04c81'
            ],
        ];
