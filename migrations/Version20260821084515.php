 ...
 */
final class Version20260821084515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadioId = 342;
        $streamSongId = 19;
        $website = 'https://www.croonerradio.fr';
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://direct.croonerradio.fr/croonerradio-hifi.mp3',
                'id' => '962eb7cc-0601-11e8-ae97-52543be04c81'
            ],
        ];
