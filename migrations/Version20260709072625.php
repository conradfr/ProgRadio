 ...
 */
final class Version20260709072625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $prefix = 'radio_couserans';
        $radioId = 164;
        $subRadioId = 327;
        $streamSongId = 134;
        $website = 'https://www.radiocouserans.fr';
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://stream.rcs.revma.com/w6u9tk4a6nhvv',
                'id' => '961669c7-0601-11e8-ae97-52543be04c81'
            ],
        ];
