 ...
 */
final class Version20260909094806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://antenne.pyreneesfm.com/direct.mp3',
                'id' => '772b048d-f7ca-4d95-8303-7d6e155ef285'
            ],
        ];
