 ...
 */
final class Version20260829085250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $prefix = 'allierpoprock';
        $radioId = 179;
        $subRadioId = 435;
        $website = 'https://www.allierpoprock.fr';

        $radios = [
            [
                'code_name' => $prefix,
                'name' => 'Allier Pop Rock',
                'category' => 2,
                'collection' => 7,
                'share' => 0,
                'country' => 'FR',
        ...
        $subRadios = [
            [
                ...
                'radio_id' => $radioId,
                'sub_radio' => true,
                'url' => 'https://play.radioking.io/allierpoprock/63703',
                'id' => '00e06741-de21-4b1c-8075-c198c2365a09'
            ],
        ];
