 ...
 */
class Version20170730132802 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE SEQUENCE schedule_entry_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP SEQUENCE schedule_entry_id_seq CASCADE');
