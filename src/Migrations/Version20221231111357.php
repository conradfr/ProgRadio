 ...
 */
final class Version20221231111357 extends AbstractMigration implements ContainerAwareInterface
{
    private $container;
    ...
    public function postUp(Schema $schema): void
    {
        ...
        $stream = [
            [
                'code_name'    => 'lovely_main',
                'name'         => 'Lovely',
                'radio_id'     => 118,
                'url'          => 'https://lovely.ice.infomaniak.ch/lovely-96.aac',
                'current_song' => 'true',
                'main'         => 'true',
                'enabled'      => 'true',
            ]
        ...
        for ($i = 0; $i < count($radios); $i++) {
            $connection->exec(
                ...
                .($i + 118).','.$radios[$i]['category'].",'".$radios[$i]['codename']."','".$radios[$i]['name']."','".$radios[$i]['country']."','".$radios[$i]['timezone']."',".$radios[$i]['share'].",".$radios[$i]['collection'].");"
            );
        }
