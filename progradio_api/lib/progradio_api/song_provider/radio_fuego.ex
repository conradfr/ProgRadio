defmodule ProgRadioApi.SongProvider.RadioFuego do
  require Logger
  ...
  def get_data(name, _last_data) do
    try do
      ...
      _ ->
        Logger.debug("Data provider - #{name} (radio_fuego): data error rescue")
        :error
    end
  end
  ...
  def get_song(name, data, _last_song) do
    try do
      Logger.debug("Data provider - #{name} (radio_fuego): data")
      ...
      _ ->
        Logger.debug("Data provider - #{name} (radio_fuego): song error rescue")
        :error
    end
  end
end
