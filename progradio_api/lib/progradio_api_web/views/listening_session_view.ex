defmodule ProgRadioApiWeb.ListeningSessionView do
  ...
  def render("show.json", %{listening_session: listening_session}) do
    %{data: render_one(listening_session, ListeningSessionView, "listening_session.json")}
  end

  def render("listening_session.json", %{listening_session: listening_session}) do
