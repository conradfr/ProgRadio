  ...
  es: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Ningún oyente actualmente. | Un oyente actualmente. | {how_many} oyentes actualmente.',
        more: 'Ver más',
  ...
  de: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Derzeit keine Hörer. | Derzeit ein Hörer. | Derzeit {how_many} Hörer.',
        more: 'Mehr anzeigen',
  ...
  pt: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Nenhum ouvinte no momento. | Um ouvinte no momento. | {how_many} ouvintes no momento.',
        more: 'Ver mais',
  ...
  it: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Nessun ascoltatore al momento. | Un ascoltatore al momento. | {how_many} ascoltatori al momento.',
        more: 'Vedi di più',
  ...
  pl: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Obecnie brak słuchaczy. | Obecnie jeden słuchacz. | Obecnie {how_many} słuchaczy.',
        more: 'Zobacz więcej',
  ...
  el: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Κανένας ακροατής αυτή τη στιγμή. | Ένας ακροατής αυτή τη στιγμή. | {how_many} ακροατές αυτή τη στιγμή.',
  ...
  ro: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Niciun ascultător în prezent. | Un ascultător în prezent. | {how_many} ascultători în prezent.',
        more: 'Vezi mai multe',
  ...
  hu: {
    message: {
      ...
      streaming: {
        ...
        listeners: 'Jelenleg nincs hallgató. | Jelenleg egy hallgató van. | Jelenleg {how_many} hallgató van.',
