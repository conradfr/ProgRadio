  ...
  fr: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Une fenêtre popup sera ouverte pour jouer cette radio',
  ...
  en: {
    message: {
      ...
      streaming: {
        ...
        popup: 'A popup window must be open to play this radio',
        history: 'Last songs:',
  ...
  es: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Una ventana emergente debe estar abierta para reproducir esta radio',
  ...
  de: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Ein Pop-up-Fenster muss geöffnet sein, um dieses Radio abzuspielen',
  ...
  pt: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Uma janela pop-up deve estar aberta para tocar esta rádio',
  ...
  it: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Una finestra pop-up deve essere aperta per riprodurre questa radio',
  ...
  pl: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Okno wyskakujące musi być otwarte, aby odtworzyć to radio',
  ...
  el: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Πρέπει να είναι ανοιχτό ένα αναδυόμενο παράθυρο για να ακούσετε αυτό το ραδιόφωνο',
  ...
  ar: {
    message: {
      ...
      streaming: {
        ...
        popup: 'يجب أن يكون نافذة منبثقة مفتوحة لتشغيل هذا الراديو',
        history: 'آخر الأغاني:',
  ...
  ro: {
    message: {
      ...
      streaming: {
        ...
        play: 'Ascultă {radio}',
        playing: 'Titlu',
        playing_errors: 'Au fost raportate erori de citire pentru acest post de radio',
        popup: 'O fereastră pop-up trebuie să fie deschisă pentru a reda acest post de radio',
  ...
  hu: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Egy felugró ablaknak nyitva kell lennie ehhez a rádió lejátszásához',
  ...
  tr: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Bu radyoyu çalmak için bir açılır pencere açık olmalıdır',
  ...
  nl: {
    message: {
      ...
      streaming: {
        ...
        popup: 'Er moet een pop-upvenster open staan om deze radio af te spelen',
