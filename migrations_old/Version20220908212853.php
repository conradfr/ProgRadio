 ...
 */
final class Version20220908212853 extends AbstractMigration implements ContainerAwareInterface
{
    private $container;
    ...
    public function postUp(Schema $schema): void
    {
        ...
        $stream = [
            [
                'code_name'    => 'forever_main',
                'name'         => 'Forever Bordeaux',
                'radio_id'     => 117,
        ...
        for ($i = 0; $i < count($radios); $i++) {
            $connection->exec(
                ...
                .($i + 117).','.$radios[$i]['category'].",'".$radios[$i]['codename']."','".$radios[$i]['name']."','".$radios[$i]['country']."','".$radios[$i]['timezone']."',".$radios[$i]['share'].",".$radios[$i]['collection'].");"
            );
        }
